...
import { StyleSheet, Text, View, TouchableOpacity, Alert, ImageBackground, TextInput, ActivityIndicator } from 'react-native'
...
let endpoint = "http://10.84.48.6:8888/";
...
class App extends React.Component {
  ...
  async componentDidMount() {
    // var ws = new WebSocket(encodeURI(endpoint + "ws"),'json');
    var ws = new WebSocket("ws://10.84.48.6:8888/ws",'json');
    console.log(ws.url)
    this.webSocket = ws;
